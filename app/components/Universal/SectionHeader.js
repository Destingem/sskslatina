...
export default function SectionHeader({style, children,mainText, btnText, btnLink,subtitle, ...props}){
    const {width} = useViewportSize();
    const device = useDevice(width)
    return(
       <div style={device !== "m" ? {marginBottom: "5vh", marginTop: "1vh", ...style} : {marginBottom: "2vh", marginTop: "1vh", ...style}}>
