...
import Content from '../nadchazejici/Content';
...
export default async function NadchazejiciSouteze(p){
    ...
    return(
        <main>
            <HeroSection name="Výsledky soutěží" >
            Na této stránce najdete výsledky soutěží pořádaných naším klubem.
            </HeroSection>
            <div style={{padding: "2vh 5vw"}}>
            <Content nadchazejiciSouteze={ukonceneSouteze} device={device} />
      </div>
        </main>
    )
}