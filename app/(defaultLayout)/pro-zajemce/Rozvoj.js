...
export default function Rozvoj({device, id}){
    return(
       ...
       <Group>
        ...
        <Text mt={"2vh"} size="lg" lh={"175%"} maw={"70%"}>K trenérství ve sportovní střelbě je potřeba mnoho znalostí a schopností. <br />
